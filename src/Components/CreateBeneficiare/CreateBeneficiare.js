...
const initialState = {
    ...
    errorIBAN:'', errorAdresse1:'', errorAdresse2:'', errorAdresse3:'',
}
    ...
    render() {
        return<div>
            <Form onSubmit={this.submitform}>
                    ...
                    <Row>
                        <Col>
                            ...
                            <Form.Control size="sm" as="select" name="nature" onChange={this.handleOnChange}
                                ...
                                <option name="Virement international">Virement international</option>
                            </Form.Control>
                ...
                <Button disabled={!this.state.isFormValid} type="submit" className="btnEnvoyer" variant="secondary">Envoyer</Button><br/><br/><br/>
            </Form>
            </div>;
    }
}
